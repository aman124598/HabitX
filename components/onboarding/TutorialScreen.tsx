...
const tutorialCards: TutorialCard[] = [
  {
    ...
    description: 'Build better habits by tracking them daily. Create custom habits and mark them complete each day.',
    color: '#3B82F6',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: 'Compete with friends and the community. Join challenges to stay accountable together.',
    color: '#8B5CF6',
  },
  {
    id: 4,
    ...
    description: 'Visualize your growth with detailed statistics and insights about your habits.',
    color: '#10B981',
  },
  {
    id: 5,
    icon: 'rocket-outline',
    title: 'Level Up',
    description: 'Earn XP and unlock achievements as you build better habits. Make progress fun!',
    color: '#EC4899',
  },
];
